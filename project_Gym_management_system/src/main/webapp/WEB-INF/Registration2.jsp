...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-90">
				<input type="radio" id="male" name="gender" value="male" />Male <input
					...
					<input
					 type="radio" id="Other" name="gender" value="Other" />Other
			</div>
		</div>
		<div class="row">
			<div class="col-10">
		...
		<div class="row">
			<div class="col-10">
				<label for="specialization">Preferred Training:</label>
			</div>
			<div class="col-90">
				<input type="checkbox" class="Preferred Training" id="cs"
					name="Preferred Training" value="Computer Science">Computer
