...
<div id="login-form-wrap">
  ...
  <form action="" method="">
    ...
    <input type="text" name="firstname" placeholder="Enter firstname" size="15"/><i class="validation"><span></span><span></span></i>
    </p>
    <p>
    <input type="text" name="lastname" placeholder="Enter lastname" size="15"/><i class="validation"><span></span><span></span></i>
    </p>
    <p>
    <label>Age:</label>
